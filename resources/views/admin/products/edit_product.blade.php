            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{url('/admin/edit-product/'.$productDetails->id)}}" name="edit_product" id="edit_product" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                 ...
                 <input type="text" name="product_name" value="<?php echo $productDetails->product_name;  ?>">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="product_code" id="product_code" value="<?php echo $productDetails->product_code;  ?>">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="product_color" id="product_color" value="<?php echo $productDetails->product_color;  ?>">
                </div>
              </div>
             ...
             <div class="control-group">
               <label class="control-label">Description</label>
                <div class="controls">
                  ...
                  <textarea name="description" id="description"><?php echo $productDetails->description;  ?></textarea>
                </div>
              </div>
               ...
               <label class="control-label">Material & Care</label>
                <div class="controls">
                  ...
                  <textarea name="care" id="care"><?php echo $productDetails->care;  ?></textarea>
                </div>
              </div>
