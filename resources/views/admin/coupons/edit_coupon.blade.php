...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Coupon</a> <a href="#" class="current">Edit Couponss</a> </div>
    <h1>Edit Coupon</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>  
            ...
            <form class="form-horizontal"method="post" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}" name="edit_coupon" id="add_coupon" >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input   value="{{$couponDetails->coupon_code}}" type="text" name="coupon_code" id="coupon_code" value="" minlength="5" maxlength="10" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="number" name="amount" id="amount" min="0" value="{{$couponDetails->amount}}">
                </div>
              </div>
