        ...
        @endif 
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
							...
							<div id="similar-product" class="carousel slide" data-ride="carousel">
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										...
										<img class="changeImage" src="{{asset('/images/backend_images/products/small/'.$altimage->image)}}" style="cursor: pointer;" alt=""></a>
										  @endforeach
										</div>
						...
						<div class="col-sm-7">
							<form name="addtocartForm" id="addtocartFrom" action="{{url('add-cart')}}" method="post">{{csrf_field()}}
